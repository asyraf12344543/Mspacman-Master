...
import pacman.controllers.examples.try1;
import pacman.controllers.examples.try0;
import pacman.controllers.examples.tryTest;
import pacman.controllers.examples.MyPacMan2;
...
{	
	...
	public static void main(String[] args)
	{
		...
		System.out.println("TEST PACMAN vs STARTER GHOST");
//		exec.runGame(new try1(), new StarterGhosts(), visual,delay);
...
//		System.out.println("A* vs LEGACY");
//		exec.runExperiment(new StarterPacMan(), new StarterGhosts(),numTrials);
